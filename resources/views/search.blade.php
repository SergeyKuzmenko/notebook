  ...
  <section class="content">
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="card-footer p-0">
                <ul class="nav flex-column data-list">
                  ...
                  <li class="nav-item">
                    <span class="nav-link">
                      Страна рождения <p class="float-right widget-user-country"></p>
                    </span>
                  </li>
                  <li class="nav-item">
                    <span class="nav-link">
                      Город рождения <p class="float-right widget-user-city"></p>
                    </span>
                  </li>
    ...
    @if(session('deleted'))
      <div class="alert alert-success alert-dismissible">
        ...
        <h5><i class="icon fas fa-check"></i>{{ session('deleted') }}</h5>
      </div>
    @endif
    <div class="card">
      <div class="card-header border-0">
        <h3 class="card-title">Результат поиска: <b>{{ $query }}</b></h3>
      </div>
      <div class="card-body table-responsive p-0">
        ...
        @else
          <div class="card-body">
            <p class="lead">Ничего не найдено</a></p>
          </div>
        @endif
      </div>
    </div>
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data.response) {
            ...
            if (data.data.contact_note !== null) {
